...
function LoadAssinCourse(id) {
    document.getElementById('jesy').value = id;
...
//DeletePubHandMark
function DeletePubHandMark(url) {
    $.ajax({
        type: 'POST',
        url: url,
...
$('#btn').click(function () {
    var mid = document.getElementById("midMark").value;
    var midFloat = parseFloat(mid);

    if (midFloat < 0 || midFloat > 25 || isNaN(midFloat)) {
        alert("Mid Mark Is Invalid");
    }
});

$('#FinalBtn').click(function () {
    var mid = document.getElementById("FinalMark").value;
    var midFloat = parseFloat(mid);

    if (midFloat < 0 || midFloat > 50 || isNaN(midFloat)) {
        alert("Final Mark Is Invalid");
    }
});
